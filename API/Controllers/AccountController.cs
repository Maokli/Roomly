...
namespace API.Controllers
{
  public class AccountController : BaseApiController
  {
    ...
    public async Task<ActionResult<UserDto>> Register(RegisterDto regsiterDto)
    {
      ...
      var user = _mapper.Map<AppUser>(regsiterDto);

      using var hmac = new HMACSHA512();

      
      user.UserName = regsiterDto.UserName;
      user.PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes(regsiterDto.Password));
